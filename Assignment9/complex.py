...
class MyComplexNumber:    
    ...
    def __sub__(self,ix):        
        real_part = self.get_real() - ix.get_real()
        imag_part = self.get_imag() - ix.get_imag()
        result = MyComplexNumber(real_part, imag_part)
        return result
    ...
    def __truediv__(self,other):        
        ...
        real_part_top = self.get_real() * other.get_real() + ((-1) * (self.get_imag() * (-1 * other.get_imag())))
        imag_part_top = self.get_real() * other.get_imag() + self.get_imag() * other.get_real()
        bottom = other.get_real()**2 + other.get_imag()**2
        result = MyComplexNumber((real_part_top/bottom), (imag_part_top/bottom))
        return result 
